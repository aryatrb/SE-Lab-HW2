...
در این صورت نیازی به افزودن تابع ارسال پیام تلگرامی در کلاس MessageService نبود. به علاوه نیازی نبود تابع sendTelegramMessage به کلاس‌های EmailMessageService و SmsMessageService اضافه شود. بنابراین سه مورد از تغییرات بخش دوم حذف می‌شدند(موارد شماره ۱ و ۳ و ۴) و دو مورد باقی می‌ماندند(موارد شماره ۲ و ۵)

سوال دوم:

رعایت اصول شی‌گرایی باعث افزایش قابلیت استفاده مجدد و کاهش پیچیدگی کد می‌شود، همچنین نگهداری و تست نرم‌افزار را آسان‌تر و مؤثرتر می‌کند. همچنین با رعایت این أصول خوانایی کد افزایش می‌یابد که همکاری در تیم را بهبود بخشیده و انعطاف‌پذیری سیستم را افزایش می‌دهد.
